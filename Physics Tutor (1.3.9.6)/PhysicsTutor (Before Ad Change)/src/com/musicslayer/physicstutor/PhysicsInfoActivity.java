...
public class PhysicsInfoActivity extends PhysicsActivity {
    ...
    LinearLayout makeInfo () {
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
        	public void onClick(View v) {
        		startActivity(new Intent(PhysicsInfoActivity.this, PhysicsInput2Activity.class));
            }
        });
    ...
    private void fillInfo()
    {
        ...
        helper.setLayoutParams(new ViewGroup.LayoutParams(dpToPx((int)(310*scale)), dpToPx((int)(310*scale))));
