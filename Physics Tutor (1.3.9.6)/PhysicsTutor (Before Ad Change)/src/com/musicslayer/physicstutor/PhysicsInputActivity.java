...
public class PhysicsInputActivity extends PhysicsActivity {
    ...
    public Spinner makeSpinner(final int r, final int s, final int t, final String unit) {
        ...
        CustomAdapter<CharSequence> A = new CustomAdapter<CharSequence>(this, android.R.layout.simple_spinner_item, this.getResources().getTextArray(getResources().getIdentifier("unit_"+unit, "array", getPackageName())));
