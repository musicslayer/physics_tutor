...
public class PhysicsSolverActivity extends PhysicsActivity {
    ...
    public LinearLayout makeSplitSolverExplanation() {
        ...
        LA.setOrientation(1);
        LA.setLayoutParams(new ViewGroup.LayoutParams(dpToPx((int)(260*scale)), dpToPx((int)(260*scale))));
        ...
        T_Display1.setTextSize(1,14*scale);
        ...
        T_Constants.setTextSize(1,14*scale);
    ...
    public LinearLayout makeSplitSolverAnswers() {
        ...
        T_Display2.setTextSize(1,14*scale);
    ...
    public Button makeViewExplanationButton() {
        ...
        b.setTextSize(1,32*scale);
        b.setLayoutParams(new ViewGroup.LayoutParams(dpToPx((int)(250*scale)), dpToPx((int)(200*scale))));
        b.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                split=true;
                L=L_Explanation;
    ...
    public LinearLayout makeSolver() {
        ...
        T_Display.setTextSize(1,14*scale);
    ...
    public void makeAnswersRow(int i, String name, String unit) {
        ...
        varName.setTextSize(1,14*scale);

        E_varInput[i]=new EditText(this);
        E_varInput[i].setTextSize(1,14*scale);
        E_varInput[i].setWidth(dpToPx((int)(80*scale)));
        ...
        B_Solve[i].setTextSize(1,14*scale);
        ...
        T_varAnswer[i].setTextSize(1,14*scale);
    ...
    public void assignExplanation() {
        ...
        else if ("SPRING".equals(type))
        {
            ...
            helperImage[2]=R.raw.helper_spring_2;
            ShelperImage[2]="helper_spring_2";
            break;
            case 2:
            ...
            helperImage[4]=R.raw.helper_spring_4_1;
            ShelperImage[4]="helper_spring_4_1";
            break;
            case 2:
            ...
            helperImage[4]=R.raw.helper_spring_4_4;
            ShelperImage[4]="helper_spring_4_4";
            break;
            case 5:
            ...
            helperImage[4]=R.raw.helper_spring_4_5;
            ShelperImage[4]="helper_spring_4_5";
            break;
            }
            ...
            helperImage[5]=R.raw.helper_spring_5;
            helperImage[6]=R.raw.helper_spring_6;
            helperImage[7]=R.raw.helper_spring_7;
            helperImage[8]=R.raw.helper_spring_8;
            ShelperImage[5]="helper_spring_5";
            ShelperImage[6]="helper_spring_6";
            ShelperImage[7]="helper_spring_7";
            ShelperImage[8]="helper_spring_8";
        }
    }
