...
public class PhysicsHelpActivity extends PhysicsActivity {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE)
        {
            ...
            ((LinearLayout) findViewById(R.id.LinearLayoutB)).setOrientation(1);
        }
        else if (newConfig.orientation == Configuration.ORIENTATION_PORTRAIT)
        {
            ...
            ((LinearLayout) findViewById(R.id.LinearLayoutB)).setOrientation(0);
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        b2=(Button) findViewById(R.id.constants);
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	help.setText("Email Developer:" +
                    ...
                    "\n\nNote: Your device must have a email application installed to use this feature.");
            }
        });
    }
}