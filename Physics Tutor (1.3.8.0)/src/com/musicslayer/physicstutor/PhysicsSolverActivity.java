...
public class PhysicsSolverActivity extends PhysicsActivity {
    ...
    public void assignExplanation() {
        ...
        {
            stotal=1;
            instructions[1]="Explanation coming soon.";
            helperImage[1]=R.raw.default_image;
            /*
            stotal=16;
            ...
            switch (option[1]) {
        	case 1:
            instructions[2]="There are a few ways to write the general solution to this equation. Based on preference, we will use a Cosine wave. The position can be written in terms of the Amplitude A, a phase shift P, the angular frequency w, and time t.";
            break;
            case 2:
            instructions[2]="There are a few ways to write the general solution to this equation. Based on preference, we will use a Sine wave. The position can be written in terms of the Amplitude A, a phase shift P, the angular frequency w, and time t.";
            break;
            }
            switch (option[0]) {
            case 1:
            ...
            switch (option[2]) {
            case 1:
            instructions[4]="We are given the position and velocity of the mass at t=0. We can differentiate position to get velocity. Then, we plug in the initial conditions to obtain two equations. We can solve these equations to get the amplitude and phase shift.";
            break;
            case 2:
            instructions[4]="We are given the amplitude and the phase shift of the oscillation.";
            break;
            case 3:
            instructions[4]="We are given the total energy and the phase shift of the oscillation, but we want the amplitude. The potential energy of a spring will be the most when the spring is stretched the most. We can use this knowledge to solve for the amplitude.";
            break;
            }
            instructions[5]="We now know everything to write the position. Now, we can differentiate position to get a function for velocity and for acceleration.";
