...
class CustomSpinner extends Spinner {
    ...
    public CustomSpinner(Context context, int stuff, CharSequence prompt, int selection) {
        this(context,context.getResources().getTextArray(stuff),prompt,selection,-2,50);
    }

    public CustomSpinner(Context context, int stuff, CharSequence prompt) {
        this(context,context.getResources().getTextArray(stuff),prompt,0,-2,50);
    }

    public CustomSpinner(Context context, CharSequence[] Sstuff, CharSequence prompt) {
        this(context,Sstuff,prompt,0,-2,50);
    }
...
class CustomScrollView extends ScrollView{
    ...
    {
        super.addView(v);
        //v.setPadding(v.getPaddingLeft(),v.getPaddingTop(),v.getPaddingRight()+dpToPx(10),v.getPaddingBottom());
    }
...
class CustomHorizontalScrollView extends HorizontalScrollView{
    ...
    {
        super.addView(v);
       // v.setPadding(v.getPaddingLeft(),v.getPaddingTop(),v.getPaddingRight(),v.getPaddingBottom()+dpToPx(10));
    }
...
class CustomEditText extends EditText {
    ...
    public CustomEditText(Context context, int originalWidth, int originalHeight, float originalTextSize) {
        ...
        if(PhysicsActivity.keyboardChoice==0){setInputType(3);}
        update();
    }
...
class ZoomCustomImageView extends CustomImageView {
    ...
    public View fullScreen() {
        ...
        {
            final CustomScrollView S=new CustomScrollView(getContext(),-2,-2);
            final CustomHorizontalScrollView H=new CustomHorizontalScrollView(getContext(),-1,-1);
