...
class PhysicsActivity extends Activity{
    ...
    final static String Sunit[]=new String[12];
    final static String SunitA1[]=new String[12];
    final static String SunitA2[]=new String[12];
    ...
    //final private static String LOCALYTICS = "f37443489ebdbb7d1b29908-2ddd9af0-a398-11e0-01b7-007f58cb3154";//real
    ...
    //static int adFreeSeconds=0, selection_g=0, answerChoice=0, keyboardChoice=0, defaultLength=0, defaultTime=0, defaultVelocity=0, defaultAngle=0, defaultMass=0, defaultForce=0, defaultEnergy=0, defaultFrequency=0, defaultAcceleration=0;
    static int selection_g=0, answerChoice=0, keyboardChoice=0, defaultLength=0, defaultTime=0, defaultVelocity=0, defaultAngle=0, defaultMass=0, defaultForce=0, defaultEnergy=0, defaultFrequency=0, defaultAcceleration=0;
    static double u1=0, u2=0, u3=0, u4=0, u5=0, u6=0, u7=0, u8=0, u9=0, u10=0, u11=0, u12=0, constant_g=9.8;
    static float scale=1;
    //static long adTimer=System.currentTimeMillis();
    ...
    void savePrefs() {
        ...
        //editor.putInt("adFree", adFreeSeconds);
        editor.putFloat("scale", scale);
        //editor.putLong("timer", adTimer);
    ...
    private void loadPrefs() {
        ...
        {
            //adFreeSeconds=preferences.getInt("adFree", adFreeSeconds);
            scale=preferences.getFloat("scale", scale);
            //adTimer=preferences.getLong("timer", adTimer);
    ...
    private void setScale()
    {
        ...
        //int statusHeight = pxToDp(getStatusBarHeight());
    ...
    */
    ...
    String getHumanReadableText(final String[] Sunit) {
        ...
        else if ("SPRING_SIMPLE".equals(type))
        {
            ...
            if (option[0]==1)
            {
                //TODO this should be a real unit
        ...
        else if ("SPRING".equals(type))
        {
            ...
            {
                //TODO N/m unit
                piece2="\nThe mass m="+Double.toString(var[0])+" "+Sunit[0]+", and the spring constant k="+Double.toString(var[1])+" N/m.";
            }
            else if (option[0]==2)
            {
            ...
            {
                //TODO N/m unit
                piece2="\nThe spring constant k="+Double.toString(var[0])+" N/m, and the angular frequency of oscillation ="+Double.toString(var[1])+" "+Sunit[1]+".";
            }
            if (option[2]==1)
            {
    ...
    private int unitStoN(final String s)
    {
    ...
    CustomSpinner makeSpinner(final int i, final String unit, final double[] factor, final String[] SunitChoice) {
        final String unitText[][]={{"m","cm","mm","km","in","ft"},{"s","ms"},{"m/s","cm/s","mm/s","km/s","in/s","ft/s"},{"radians","degrees"},{"kg","g"},{"N","lb"},{"J"},{"Hz"},{"m/s^2"}};
        final double unitFactor[][]={{1,0.01,0.001,1000,0.0254,0.3048},{1,0.001},{1,0.01,0.001,1000,0.0254,0.3048},{1,0.01745329},{1,0.001},{1,4.44822162},{1},{1},{1}};
        final int unitDefault[]={defaultLength,defaultTime,defaultVelocity,defaultAngle,defaultMass,defaultForce,defaultEnergy,defaultFrequency,defaultAcceleration};
        ...
        S.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                ...
                switch (pos)
                {
                    case 0: factor[i]=1; SunitChoice[i]="m"; break;
                    case 1: factor[i]=0.01; SunitChoice[i]="cm"; break;
                    case 2: factor[i]=0.001; SunitChoice[i]="mm"; break;
                    case 3: factor[i]=1000; SunitChoice[i]="km"; break;
                    case 4: factor[i]=0.0254; SunitChoice[i]="in"; break;
                    case 5: factor[i]=0.3048; SunitChoice[i]="ft"; break;
                }
                */
            }
        });
        ...
        if ("length".equals(unit)){
            ...
            S.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                    switch (pos)
                    {
                        case 0: factor[i]=1; SunitChoice[i]="s"; break;
                        case 1: factor[i]=0.001; SunitChoice[i]="ms"; break;
                    }
                }
            });
            ...
            S.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                    switch (pos)
                    {
                        case 0: factor[i]=1; SunitChoice[i]="m/s"; break;
                        case 1: factor[i]=0.01; SunitChoice[i]="cm/s"; break;
                        case 2: factor[i]=0.001; SunitChoice[i]="mm/s"; break;
                        case 3: factor[i]=1000; SunitChoice[i]="km/s"; break;
                        case 4: factor[i]=0.0254; SunitChoice[i]="in/s"; break;
                        case 5: factor[i]=0.3048; SunitChoice[i]="ft/s"; break;
                    }
                }
            });
            ...
            S.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                    switch (pos)
                    {
                        case 0: factor[i]=1; SunitChoice[i]="radians"; break;
                        case 1: factor[i]=0.017453292519943295769236907684886; SunitChoice[i]="degrees"; break;
                    }
                }
            });
            ...
            S.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                    switch (pos)
                    {
                        case 0: factor[i]=1; SunitChoice[i]="kg"; break;
                        case 1: factor[i]=0.001; SunitChoice[i]="g"; break;
                    }
                }
            });
            ...
            S.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                    switch (pos)
                    {
                        case 0: factor[i]=1; SunitChoice[i]="N"; break;
                        case 1: factor[i]=4.44822162; SunitChoice[i]="lb"; break;
                    }
                }
            });
            ...
            S.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                    switch (pos) {
                        case 0: factor[i] = 1; SunitChoice[i]="J"; break;
                    }
                }
            });
            ...
            S.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                    switch (pos) {
                        case 0: factor[i] = 1; SunitChoice[i]="Hz"; break;
                    }
                }
            });
            ...
            S.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                    switch (pos) {
                        case 0: factor[i] = 1; SunitChoice[i]="m/s^2"; break;
                    }
                }
            });
